...
/**
 * @brief Remove an L2CAP server
 *
 * This function removes an L2CAP server with the specified Protocol/Service Multiplexer (PSM)
 *
 * @param psm       The Protocol/Service Multiplexer (PSM) of the server.
 *
 * @return          0 on success;
 *                  A non-zero value on failure.
 */
