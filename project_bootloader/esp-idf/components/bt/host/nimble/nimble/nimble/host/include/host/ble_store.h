...
/** Object type: Peer device record. */
#define BLE_STORE_OBJ_TYPE_PEER_DEV_REC      4

#if MYNEWT_VAL(ENC_ADV_DATA)
/** Object type: Encrypted advertising data. */
#define BLE_STORE_OBJ_TYPE_ENC_ADV_DATA      5
#endif

/** Object type: Peer address. */
#define BLE_STORE_OBJ_TYPE_PEER_ADDR         6

/** Object type: Local IRK. */
#define BLE_STORE_OBJ_TYPE_LOCAL_IRK        7

/** Object type: Client Supported Features Characteristic. */
