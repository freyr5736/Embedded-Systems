...
int ble_sm_incr_peer_sign_counter(uint16_t conn_handle, uint32_t new_counter);
...
#define ble_sm_incr_peer_sign_counter(conn_handle, new_counter) BLE_HS_ENOTSUP
